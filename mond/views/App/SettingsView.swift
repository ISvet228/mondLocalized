            ...
            List {
                ...
                Section {
                    ...
                    if method == "cmg" {
                        ...
                        HStack(alignment: .firstTextBaseline, spacing: 4) {
                            ...
                            Link(NSLocalizedString("forcequit", comment: "Forcequit label"), destination: URL(string: "https://github.com/forcequitOS")!)
                        }
                    }
                }
                ...
                Section {
                    ...
                    HStack(alignment: .firstTextBaseline, spacing: 4) {
                        ...
                        Link(NSLocalizedString("neon", comment: "Neon label"), destination: URL(string: "https://github.com/neonmodder123")!)
                        Text(NSLocalizedString("respring_method_middle", comment: "Respring middle text"))
                        Link(NSLocalizedString("skadz", comment: "Skadz label"), destination: URL(string: "https://github.com/skadz108")!)
                    }
                }
